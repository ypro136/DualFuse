...
extern LLcontrol dsIoapic; // struct IOAPIC

// no way to deallocate vectors, should be good enough
#define MAX_IRQ 256
extern uint8_t *irqPerCpu;
extern uint8_t  irqGenericArray[MAX_IRQ];
extern uint32_t lapicGenericArray[MAX_IRQ];
